...
\begin{document}
    ...
    \begin{figure}[h]
        ...
        \begin{subfigure}[b]{0.45\textwidth}
            ...
            \end{tikzpicture}
            \caption{MST after DFS visit, adding D after the last node of the cycle}
        \end{subfigure}
        \hfill \vspace{0.1mm}
        \\ \\ \\
        \centering
   ...
   \section{Basic Features}
    ...
    \begin{center}
      ...
      \captionof{figure}{Interactive View of the Application Result}
    \end{center}
    ...
    \begin{algorithm}
	    ...
	    \Function{bruteForce}{$poi, origin, destination$}
            \If{$poi$ is $empty$}
            ...
            \Repeat 
                ...
                \If{$distance \leqslant shortDistance$}
                    \State $shortDistance \gets distance$
                    \State $shortestPath \gets copy(poi)$
                \EndIf
            \Until {$getNextPermutation(poi) = false$}
    ...
    \begin{minipage}{.47\textwidth}
      ...
      \captionof{figure}{Mean of times for path finding. Blue stands for Dijkstra, red stands for A*}
      \label{fig:pathmean}
    \end{minipage}%
    \hspace{.03\textwidth} 
    \begin{minipage}{.47\textwidth}
    \centering
      ...
      \captionof{figure}{Median of times for path finding. Blue stands for Dijkstra, red stands for A*}
    ...
    \begin{minipage}{.47\textwidth}
      \centering
      \includegraphics[width = 225px]{img/bruteforcemean.png}
      \captionof{figure}{Mean of times for Traveling Salesman. Blue is Brute Force, red is Kruskal, yellow is Nearest Neighbour}
      \label{fig:brutemean}
    \end{minipage}%
    \hspace{.03\textwidth} 
    \begin{minipage}{.47\textwidth}
    \centering
      \includegraphics[width = 235px]{img/bruteforcemedian.png}
      \captionof{figure}{Median of times for Traveling Salesman. Blue is Brute Force, red is Kruskal, yellow is Nearest Neighbour}
      \label{fig:brutemedian}
    \end{minipage}
    \end{figure}
        \begin{figure}[H]
    \centering
    \begin{minipage}{.47\textwidth}
      \centering
      \includegraphics[width = 225px]{img/tspmean.png}
      \captionof{figure}{Mean of times for Traveling Salesman. Red is Kruskal, yellow is Nearest Neighbour}
      \label{fig:tspmean}
    \end{minipage}%
    \hspace{.03\textwidth} 
    \begin{minipage}{.47\textwidth}
    \centering
      \includegraphics[width = 235px]{img/tspmedian.png}
      \captionof{figure}{Median of times for Traveling Salesman. Red is Kruskal, yellow is Nearest Neighbour}
      \label{fig:tspmedian}
    \end{minipage}
    \end{figure}
    ...
    \begin{center}
      ...
      \captionof{figure}{Mean of times for Traveling Salesman. Blue is brute force, red is the trend line.}
    \end{center}
    ...
    \begin{minipage}{.47\textwidth}
      ...
      \captionof{figure}{Mean of times for Traveling Salesman. Red is Kruskal, yellow is the trend line.}
      \label{fig:msttrend}
    \end{minipage}%
    \hspace{.03\textwidth} 
    \begin{minipage}{.47\textwidth}
    \centering
      ...
      \captionof{figure}{Mean of times for Traveling Salesman. Yellow is Nearest Neighbour, red is the trend line.}
    ...
    \begin{minipage}{.47\textwidth}
      ...
      \captionof{figure}{Mean percentage of the optimal solution per algorithm. Red is Kruskal, yellow is Nearest Neighbour}
    ...
    \centering
      ...
      \captionof{figure}{Mean Distance travelled by the solutions of each algorithm. Red is Kruskal, yellow is Nearest Neighbour}
