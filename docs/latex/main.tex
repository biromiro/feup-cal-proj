...
\begin{document}
    ...
    \begin{figure}[h]
        ...
        \begin{subfigure}[b]{0.45\textwidth}
            ...
            \draw[ultra thick] (3) -- node[midway, right]{$w_2$} (5);
            \draw[ultra thick] (4) -- node[midway, above, sloped]{$w_3$} (5);
        ...
        \begin{subfigure}[b]{0.45\textwidth}
            ...
            \draw[ultra thick] (3) -- node[midway, left]{$w_2$} (5);
